...
static const unsigned int timeGenesisBlock = 1393697176;
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "MtGox bankruptcy Bitcoin insiders saw problems with the exchange";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
